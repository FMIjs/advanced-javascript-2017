// rss stream reader with nodejs and express solution by g.pekov
...
app.get('/', (req, res) => {
  ...
  const tolistTransform = new Transform({
    // this objectMode allows transformer  
    // to work with objects, as the previous
    // stream in the pipe line emits objects
    objectMode: true,
